...
rule deeptools_plot_coverage:
    input:
        bamfiles=expand(
            "results/dedup/{unit.sample}-{unit.unit}.bam", unit=units.itertuples()
        ),
        bamindicies=expand(
            "results/dedup/{unit.sample}-{unit.unit}.bam.bai", unit=units.itertuples()
        ),
    output:
...
rule multiqc:
    input:
        get_fastqc,
        expand(
            "results/trimmed/{unit.sample}-{unit.unit}.qc.txt", unit=units.itertuples()
        ),
        expand(
            "qc/samtools_stats/{unit.sample}-{unit.unit}.txt", unit=units.itertuples()
        ),
        expand(
            "results/dedup/{unit.sample}-{unit.unit}.metrics.txt",
